<template>
    <v-footer light padless class="mt-15">
        <v-row>
            <v-col>
            ...
            <v-card-text>
                <v-row class="mt-5">
                    ...
                    <v-col cols="8">
                        <v-row>
                            <v-col cols="3">
                                <span class="font-weight-bold">Fundraise for</span>
                                <v-row class="mt-1">
                                    <v-col>
                                ...
                                <v-row>
                                    <v-col>
                                        <span class="font-weight-bold">Memorial</span>
                                    </v-col>
                                </v-row>
                                <v-row>
                                    <v-col style="margin: 0; padding: 0;">
                                        <span class="font-weight-bold">Non Profit</span>
                                    </v-col>
                                </v-row>
                            </v-col>
                            ...
                            <v-col cols="3">
                                ...
                                <v-row class="mt-1">
                                    <v-col>
                                        <span class="font-weight-bold">How It Works</span>
                                    </v-col>
                                </v-row>
                            </v-col>
                            ...
                            <v-col cols="3" class="font-weight-bold">
                                ...
                                <v-row class="mt-1">
                                    <v-col>
                                        <span class="font-weight-bold">Abouts Us</span>
                                    </v-col>
                                </v-row>
                                <v-row>
                                    <v-col style="margin: 0; padding: 0;">
            ...
            <v-card-text class="white--text-center">
                {{ new Date().getFullYear() }} — <strong>Charity</strong>
            </v-card-text>
        </v-card>
            </v-col>
        </v-row>
